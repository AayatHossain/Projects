...
const en = {
  ...
  'notif.subtitle': 'Auto-detected from your SMS',
  'notif.scanNow': '↻ Scan SMS now',
...
const bn: Record<TKey, string> = {
  ...
  'notif.title': 'লেনদেন',
  'notif.subtitle': 'আপনার SMS থেকে স্বয়ংক্রিয়ভাবে শনাক্ত',
  'notif.scanNow': '↻ এখন SMS স্ক্যান করুন',
