...
const en = {
  ...
  'advisor.homeCard': 'Should you buy it?',
  'advisor.homeCardSub': 'AI purchase advice before you spend',
...
const bn: Record<TKey, string> = {
  ...
  'advisor.homeCard': 'এটি কি কেনা উচিত?',
  'advisor.homeCardSub': 'খরচের আগে এআই পরামর্শ',
