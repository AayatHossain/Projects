...
const en = {
  ...
  'txn.out': 'Spent',
  'txn.saved': 'Saved',
  'txn.empty': 'No transactions yet. They appear here as you spend, receive, or save.',
  'txn.today': 'Today',
  'txn.yesterday': 'Yesterday',
  'txn.received': 'Received',
  'txn.spent': 'Spent',
  'txn.sent': 'Sent',
  'txn.savedTo': 'Saved to {g}',
  'txn.via': 'via {p}',
  'txn.manual': 'Manual',
...
const bn: Record<TKey, string> = {
  ...
  'txn.out': 'খরচ',
  'txn.saved': 'সঞ্চয়',
  'txn.empty': 'এখনো কোনো লেনদেন নেই। খরচ, জমা বা সঞ্চয় করলে এখানে দেখা যাবে।',
  'txn.today': 'আজ',
  'txn.yesterday': 'গতকাল',
  'txn.received': 'জমা হয়েছে',
  'txn.spent': 'খরচ',
  'txn.sent': 'পাঠানো',
  'txn.savedTo': '{g}-এ সঞ্চয়',
  'txn.via': '{p} এর মাধ্যমে',
  'txn.manual': 'ম্যানুয়াল',
