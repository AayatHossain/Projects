...
const en = {
  ...
  'pending.barTitle': '{n} transaction(s) to sort',
  'pending.barSub': 'Tap to add them from your SMS',

  'notif.title': 'Transactions',
  'notif.subtitle': 'All your transactions in one place',
  'notif.scanNow': '↻ Reload transactions',
  'notif.simulate': '✨ Simulate a transaction',
  'notif.dismissAll': '🗑 Dismiss all',
  'notif.dismissAllTitle': 'Dismiss all?',
  'notif.dismissAllMsg': 'This clears every pending transaction without adding them. This cannot be undone.',
  'notif.empty': 'No pending transactions. New bKash, Nagad or bank SMS will show up here.',
  'notif.received': 'Received',
  'notif.spent': 'Spent',
  'notif.fee': 'Fee ৳{n}',
  'notif.via': 'via {provider}',
  'notif.pickCategory': 'Add to which category?',
  'notif.addExpense': 'Add to expenses',
  'notif.saveToGoal': 'Save to a goal',
  'notif.pickGoal': 'Choose a goal',
  'notif.noGoals': 'No goals yet — add one in the Goals tab.',
  'notif.dismiss': 'Dismiss',
  'notif.permissionHint': 'On Android, allow SMS access to auto-detect transactions — or tap Simulate to try it.',

  'shop.title': 'Smart Shopper',
  'shop.subtitle': 'Compare real prices across Bangladesh',
  'shop.placeholder': 'Search anything — rice, iPhone, soap…',
  'shop.search': 'Search',
  'shop.searching': 'Searching the market…',
  'shop.needQuery': 'Type something to search.',
  'shop.error': 'Could not search. Try again.',
  'shop.results': '{n} results, cheapest first',
  'shop.savings': 'Save up to {c}{n}',
  'shop.noResults': 'No products found. Try a different name.',

  'advisor.title': 'Should You Buy It?',
  'advisor.subtitle': 'A data-driven decision before you spend',
  'advisor.homeCard': 'Smart Shopper',
  'advisor.homeCardSub': 'Compare prices before you spend',
  'advisor.productLabel': 'Product name',
  'advisor.productPlaceholder': 'iPhone 15 Pro, Dyson V12…',
  'advisor.priceLabel': 'Price (optional)',
  'advisor.budgetLabel': 'My budget (optional)',
  'advisor.linkLabel': 'Product link (optional)',
  'advisor.submit': 'Should I buy it?',
  'advisor.analyzing': 'Analyzing the market…',
  'advisor.needProduct': 'Enter a product name first.',
  'advisor.whereToBuy': 'Where to buy',
  'advisor.bestPrice': 'BEST PRICE',
  'advisor.alternatives': 'Cheaper alternatives',
  'advisor.save': 'Save {c}{n} ({p}%)',
  'advisor.youSave': 'You can save {c}{n}',
  'advisor.noOffers': 'No price listings found. Try a more specific product name.',
  'advisor.error': 'Could not get advice. Try again.',
  'advisor.view': 'View →',
  'advisor.verdictBuy': '✅ Buy it',
  'advisor.verdictWait': '✋ Wait',
  'advisor.verdictAlt': '🔄 Consider an alternative',
  ...
  'budget.reset': 'Reset budget and expenses',
  'budget.resetTitle': 'Reset budget?',
  'budget.resetMsg': 'This clears all category allocations and deletes every expense. Your income is kept. This cannot be undone.',
  ...
  'budget.savedMsg': 'Income set and auto-allocated across categories. Tap Edit to fine-tune.',
  ...
  'learning.subtitle': 'Money courses & quizzes',
  'learning.pointsEarned': 'TakaPoints earned',
  'learning.lecture': 'Lecture {n}: {title}',
  'learning.markComplete': 'Mark as complete',
  'learning.completed': 'Completed',
  'learning.takeQuiz': 'Take quiz',
  'learning.retakeQuiz': 'Retake quiz',
  'learning.lockHint': 'Mark the lecture complete to unlock its quiz.',
  'learning.moreSoon': 'More courses coming soon.',

  'quiz.notFound': 'Quiz not found.',
  'quiz.lectureQuiz': 'Lecture {n} quiz',
  'quiz.questionOf': 'Question {a} of {b}',
  'quiz.next': 'Next',
  'quiz.seeResult': 'See result',
  'quiz.correctPrefix': '✅ Correct! ',
  'quiz.wrongPrefix': '❌ ',
  'quiz.passMsg': 'Well done! You earned +{n} TakaPoints',
  'quiz.failMsg': 'Good try — review and retake.',
...
const bn: Record<TKey, string> = {
  ...
  'pending.barTitle': '{n}টি লেনদেন সাজাতে বাকি',
  'pending.barSub': 'SMS থেকে যোগ করতে ট্যাপ করুন',

  'notif.title': 'লেনদেন',
  'notif.subtitle': 'আপনার সব লেনদেন এক জায়গায়',
  'notif.scanNow': '↻ লেনদেন রিলোড করুন',
  'notif.simulate': '✨ একটি লেনদেন সিমুলেট করুন',
  'notif.dismissAll': '🗑 সব বাতিল করুন',
  'notif.dismissAllTitle': 'সব বাতিল করবেন?',
  'notif.dismissAllMsg': 'এটি সব পেন্ডিং লেনদেন যোগ না করেই মুছে দেবে। এটি ফেরানো যাবে না।',
  'notif.empty': 'কোনো পেন্ডিং লেনদেন নেই। নতুন বিকাশ, নগদ বা ব্যাংক SMS এখানে দেখা যাবে।',
  'notif.received': 'জমা',
  'notif.spent': 'খরচ',
  'notif.fee': 'ফি ৳{n}',
  'notif.via': '{provider} এর মাধ্যমে',
  'notif.pickCategory': 'কোন ক্যাটাগরিতে যোগ করবেন?',
  'notif.addExpense': 'খরচে যোগ করুন',
  'notif.saveToGoal': 'লক্ষ্যে সঞ্চয় করুন',
  'notif.pickGoal': 'একটি লক্ষ্য বাছুন',
  'notif.noGoals': 'এখনো কোনো লক্ষ্য নেই — Goals ট্যাবে একটি যোগ করুন।',
  'notif.dismiss': 'বাতিল করুন',
  'notif.permissionHint': 'Android-এ লেনদেন স্বয়ংক্রিয়ভাবে শনাক্ত করতে SMS অ্যাক্সেস দিন — অথবা চেষ্টা করতে সিমুলেট চাপুন।',

  'shop.title': 'স্মার্ট শপার',
  'shop.subtitle': 'বাংলাদেশজুড়ে আসল দাম তুলনা করুন',
  'shop.placeholder': 'যেকোনো কিছু খুঁজুন — চাল, আইফোন, সাবান…',
  'shop.search': 'খুঁজুন',
  'shop.searching': 'বাজার খোঁজা হচ্ছে…',
  'shop.needQuery': 'খুঁজতে কিছু লিখুন।',
  'shop.error': 'খোঁজা যায়নি। আবার চেষ্টা করুন।',
  'shop.results': '{n}টি ফলাফল, সস্তা আগে',
  'shop.savings': '{c}{n} পর্যন্ত সাশ্রয়',
  'shop.noResults': 'কোনো পণ্য পাওয়া যায়নি। অন্য নাম লিখুন।',

  'advisor.title': 'কেনা উচিত?',
  'advisor.subtitle': 'খরচের আগে তথ্যভিত্তিক সিদ্ধান্ত',
  'advisor.homeCard': 'স্মার্ট শপার',
  'advisor.homeCardSub': 'খরচের আগে দাম তুলনা করুন',
  'advisor.productLabel': 'পণ্যের নাম',
  'advisor.productPlaceholder': 'iPhone 15 Pro, Dyson V12…',
  'advisor.priceLabel': 'দাম (ঐচ্ছিক)',
  'advisor.budgetLabel': 'আমার বাজেট (ঐচ্ছিক)',
  'advisor.linkLabel': 'পণ্যের লিংক (ঐচ্ছিক)',
  'advisor.submit': 'কেনা উচিত কি?',
  'advisor.analyzing': 'বাজার বিশ্লেষণ হচ্ছে…',
  'advisor.needProduct': 'আগে একটি পণ্যের নাম লিখুন।',
  'advisor.whereToBuy': 'কোথায় কিনবেন',
  'advisor.bestPrice': 'সেরা দাম',
  'advisor.alternatives': 'সাশ্রয়ী বিকল্প',
  'advisor.save': 'সাশ্রয় {c}{n} ({p}%)',
  'advisor.youSave': 'আপনি সাশ্রয় করতে পারেন {c}{n}',
  'advisor.noOffers': 'কোনো দাম পাওয়া যায়নি। আরও নির্দিষ্ট নাম লিখে দেখুন।',
  'advisor.error': 'পরামর্শ পাওয়া যায়নি। আবার চেষ্টা করুন।',
  'advisor.view': 'দেখুন →',
  'advisor.verdictBuy': '✅ কিনে ফেলুন',
  'advisor.verdictWait': '✋ অপেক্ষা করুন',
  'advisor.verdictAlt': '🔄 বিকল্প ভাবুন',
  ...
  'budget.reset': 'বাজেট ও খরচ রিসেট করুন',
  'budget.resetTitle': 'বাজেট রিসেট করবেন?',
  'budget.resetMsg': 'এটি সব ক্যাটাগরির বরাদ্দ মুছে দেবে এবং সব খরচ ডিলিট করবে। আপনার আয় থাকবে। এটি ফেরানো যাবে না।',
  ...
  'budget.savedMsg': 'আয় সেট হয়েছে এবং ক্যাটাগরিতে স্বয়ংক্রিয়ভাবে বরাদ্দ হয়েছে। সূক্ষ্ম সমন্বয়ে এডিট চাপুন।',
  ...
  'learning.title': 'শেখা',
  'learning.subtitle': 'টাকা বিষয়ক কোর্স ও কুইজ',
  'learning.pointsEarned': 'অর্জিত টাকাপয়েন্ট',
  'learning.lecture': 'লেকচার {n}: {title}',
  'learning.markComplete': 'সম্পন্ন হিসেবে চিহ্নিত করুন',
  'learning.completed': 'সম্পন্ন',
  'learning.takeQuiz': 'কুইজ দিন',
  'learning.retakeQuiz': 'আবার কুইজ দিন',
  'learning.lockHint': 'কুইজ আনলক করতে লেকচারটি সম্পন্ন করুন।',
  'learning.moreSoon': 'আরও কোর্স শীঘ্রই আসছে।',

  'quiz.notFound': 'কুইজ পাওয়া যায়নি।',
  'quiz.lectureQuiz': 'লেকচার {n} কুইজ',
  'quiz.questionOf': 'প্রশ্ন {a} / {b}',
  'quiz.next': 'পরবর্তী',
  'quiz.seeResult': 'ফলাফল দেখুন',
  'quiz.correctPrefix': '✅ সঠিক! ',
  'quiz.wrongPrefix': '❌ ',
  'quiz.passMsg': 'দারুণ! আপনি +{n} টাকাপয়েন্ট পেয়েছেন',
  'quiz.failMsg': 'ভালো চেষ্টা — আবার দেখে কুইজ দিন।',
  'quiz.backToCourse': 'কোর্সে ফিরুন',
  'quiz.retake': 'আবার কুইজ দিন',
